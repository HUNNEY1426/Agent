    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-surface-950 px-4">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-zinc-400 mt-1">Sign in to AI Agent</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-surface-900/80 border border-zinc-800 rounded-2xl p-6 shadow-2xl shadow-black/60 backdrop-blur-sm">
          ...
          <div className="flex items-center justify-between mb-6">
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                className="w-3.5 h-3.5 rounded border-zinc-700 bg-surface-850 text-zinc-200 focus:ring-zinc-400 focus:ring-offset-0"
              />
          ...
          >
            {loading ? <Loader2 className="w-4 h-4 animate-spin text-white dark:text-zinc-950" /> : <><span>Sign in</span><ArrowRight className="w-4 h-4 text-white dark:text-zinc-950" /></>}
          </button>
        </form>
        ...
        <p className="mt-6 text-center text-sm text-zinc-500">
          ...
          <Link to="/signup" className="text-zinc-200 hover:text-white font-medium underline underline-offset-4 transition-colors">Sign up</Link>
        </p>
      </div>
    </div>
  );
