      ...
      <aside className={`fixed lg:static inset-y-0 left-0 z-40 w-[280px] flex flex-col bg-surface-900 border-r border-slate-800/80 transition-transform duration-300 lg:translate-x-0 ${
        ...
        <div className="px-3 pt-3 pb-1">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl bg-brand-600 hover:bg-brand-500 text-white text-sm font-medium transition-all shadow-lg shadow-brand-600/20"
          >
